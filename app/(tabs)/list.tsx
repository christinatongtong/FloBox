...
const HKU_LOCATION = { lat: 22.3022, lng: 114.1772 };
      ...
      <View style={styles.container}>
          ...
          {(
            <FlatList
                ...
                renderItem={({ item }) => <ListRow item={item} onPress={onRowPress} mode={mode} />}
                ListEmptyComponent={<Text style={styles.empty}>No dispensers match your search.</Text>}
            />
          )
        }
      </View>
